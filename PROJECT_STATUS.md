...
- **Pytest Suite:** Wrote 12 isolated unit tests with mock handlers and automatic SQLite database overrides during testing.
...
- [ ] **Secure Authentication:** Implement Google and GitHub OAuth2 sign-in flows.
